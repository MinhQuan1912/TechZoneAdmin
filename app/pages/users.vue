    ...
    <UCard>
      <div class="flex gap-3">
        ...
        <UButton
          color="neutral"
          variant="outline"
          @click="store.search = ''; store.fetchAll()"
        >
          Reset
        </UButton>
      </div>
    ...
    <UModal v-model:open="wishlistOpen">
      <template #content>
        <UCard>
          ...
          <div
            v-else
            class="space-y-2 max-h-[480px] overflow-y-auto -mx-1 px-1"
          >
            <div
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <div class="flex flex-col gap-1 mt-1">
                  <div
                    v-for="variant in item.product?.variants?.slice(0, 2)"
                    :key="variant.id"
                  ...
                  <div
                    v-if="(item.product?.variants?.length || 0) > 2"
                    class="text-xs text-gray-400"
                  >
              ...
              <div class="shrink-0 text-right">
                ...
                <p
                  v-if="maxPrice(item.product?.variants) !== minPrice(item.product?.variants)"
