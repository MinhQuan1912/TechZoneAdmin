            ...
            <div class="space-y-4">
               <UCard>
                  ...
                  <div class="space-y-2 text-sm">
                     ...
                     <div v-if="store.current.coupon" class="text-xs text-gray-400 pl-2">
            ...
            <div class="space-y-3">
               <div v-for="item in store.current.items" :key="item.id"
                  ...
                  <div class="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                     <img :src="item.variant?.imageUrl" :alt="item.product?.name"
...
const availableStatuses = computed(() => {
   ...
   const steps = nextSteps[current] || []
   return steps.map(s => ({ label: statusLabels[s as OrderStatus], value: s }))
})
