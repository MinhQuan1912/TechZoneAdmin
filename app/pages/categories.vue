        ...
        <UCard>
          ...
          <div class="space-y-4">
            ...
            <UFormField label="Ảnh danh mục">
              <div v-if="imagePreview || (editingCategory?.imageUrl && !removeExistingImage)"
                ...
                <img :src="imagePreview || editingCategory?.imageUrl || ''" class="w-full h-full object-cover">
          ...
          <template #footer>
            <div class="flex justify-end gap-3">
              <UButton color="neutral" variant="outline" @click="formOpen = false">
                Hủy
              </UButton>
      ...
      <template #content>
        <UCard>
          ...
          <div class="space-y-3">
            ...
            <UAlert v-if="(deletingCategory?._count?.products || 0) > 0" color="warning" variant="soft"
            ...
            <div v-if="(deletingCategory?._count?.products || 0) > 0" class="space-y-2">
              <label class="flex items-start gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50"
                :class="moveProducts ? 'border-primary-500 bg-primary-50' : ''" @click="moveProducts = true">
              ...
              <label class="flex items-start gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50"
                :class="!moveProducts ? 'border-red-500 bg-red-50' : ''" @click="moveProducts = false">
                <input type="radio" :checked="!moveProducts" class="mt-0.5" readonly>
                <div>
          ...
          <template #footer>
            <div class="flex justify-end gap-3">
              ...
              <UButton v-if="(deletingCategory?._count?.products || 0) === 0 || moveProducts" color="error"
