      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
         <UCard>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
               ...
               <UFormField label="Danh mục *">
                  <USelect v-model="form.categoryId" :items="categoryOptions" placeholder="Chọn danh mục"
                     class="w-full" />
               </UFormField>
         ...
         <UCard>
            ...
            <div
               ...
               <p class="text-sm text-gray-500">Kéo thả hoặc <span class="text-primary-600 font-medium">chọn ảnh</span>
               </p>
               <p class="text-xs text-gray-400 mt-1">PNG, JPG, WEBP tối đa 5MB - Có thể chọn nhiều ảnh</p>
            </div>
               ...
               <div class="grid grid-cols-4 md:grid-cols-6 gap-2">
                  <div v-for="(img, idx) in productImagePreviews" :key="idx"
                     ...
                     <button type="button"
                        ...
                        @click.stop="removeProductImage(idx)">×</button>
                  </div>
               </div>
            </div>
         </UCard>
         <UCard>
            <template #header>
               <div>
                  <h3 class="font-semibold">Biến thể sản phẩm *</h3>
                  <p class="text-xs text-gray-400 mt-0.5">
