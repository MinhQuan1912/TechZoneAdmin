  ...
  <div class="space-y-4">
      ...
      >
        <UFormField label="Tìm sản phẩm để xem đánh giá">
          <div class="relative">
            ...
            >
              <div
                v-if="dropdownOpen && searchText.length >= 1"
    ...
    <UCard v-if="selectedProduct">
      ...
      >
        <div
          v-for="i in 3"
          :key="i"
          class="animate-pulse flex gap-3 p-3"
        >
      ...
      >
        ...
        <p class="text-xs mt-1">
          Chỉ người đã mua và nhận hàng mới có thể đánh giá
        </p>
      </div>
      <div
        v-else
    ...
    >
      <div class="text-center py-12 text-gray-400">
        <UIcon
          name="i-heroicons-magnifying-glass"
          class="w-14 h-14 mx-auto mb-3 text-gray-300"
        />
        <p class="font-medium text-gray-500">
          Tìm và chọn sản phẩm
        </p>
        <p class="text-sm mt-1">
          Nhập tên sản phẩm vào ô tìm kiếm bên trên
        </p>
      </div>
    </UCard>
    <CommonAppConfirmModal
      ...
      title="Xóa đánh giá"
      message="Xóa đánh giá này? Thao tác không thể hoàn tác."
      :loading="deleting"
      @confirm="doDelete"
    />
  </div>
